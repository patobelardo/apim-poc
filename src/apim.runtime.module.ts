...
import { TenantDefaultAuthenticator } from "./components/tenantDefaultAuthenticator";
...
injector.bindSingleton("tenantHttpClient", XmlHttpRequestClient);
injector.bindSingleton("tenantAuthenticator", TenantDefaultAuthenticator);
injector.bindSingleton("tenantMapiClient", TenantMapiClient);        
